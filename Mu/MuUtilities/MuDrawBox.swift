...
public class MuDrawBox: UIView {
    ...
    public override func draw(_ rect: CGRect) {
        ...
        //let q2 = CGPoint(x: r, y: 0)
        let q3 = CGPoint(x: w - r, y: 0)
        //let q4 = CGPoint(x: w, y: r)
        let q5 = CGPoint(x: w, y: h - r)
        //let q6 = CGPoint(x: w - r, y: h)
        let q7 = CGPoint(x: r, y: h)
        //let q8 = CGPoint(x: 0, y: h - r)
