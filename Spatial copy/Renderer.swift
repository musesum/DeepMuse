...
class Renderer {
    ...
    init(_ layerRenderer: LayerRenderer) {
        ...
        self.dynamicUniformBuffer = self
            .device.makeBuffer(length:uniformBufferSize,
        ...
        do {
            pipelineState = try Renderer
                .buildRenderPipelineWithDevice(device: device,
    ...
    func renderFrame() {
        ...
        rpd.colorAttachments[0].clearColor = MTLClearColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 0.0)
