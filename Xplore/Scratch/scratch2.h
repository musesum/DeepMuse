√ {
    midi {  // musical instrument device interface
        ...
        _main {
            ...
            controller (num in 32..63, val, chan, time)
            // controller 0..31
        ...
        _omni {  // _cc removes from dispatch change to cc._sound to include
            ...
            omniMode (0..1) <<(🚫midi._omni.omniModeOff(0) midi._omni.omniModeOn(1)) , }
        cc : _main, _pedal, _omni {
            ...
            omniModeOff (num == 124, val, chan, time)
            omniModeOn (num == 125, val, chan, time)
            omniMode (0..1) <<(midi.cc.omniModeOff(0) midi.cc.omniModeOn(1)) , }
    }
}
