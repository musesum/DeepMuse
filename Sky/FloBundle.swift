...
public class FloBundle: NSObject {
    ...
    private var floScriptNames: [String]
    ...
    public init(_ bundle: Bundle,
                _ floScriptNames: [String]) {

        self.bundle = bundle
        self.floScriptNames = floScriptNames
    ...
    public func saveSkyArchive(_ name: String, 
